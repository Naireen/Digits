...

{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invite=(ButtonAwesome) findViewById(R.id.button_invite_players);
...
//        Log.d(TAG, "This is class id " + mRoomId);
    ...
    public void onDisconnectedFromRoom(Room room) {
        ...
        CharSequence text = "Your opponent lost the game. Press back to return to the main menu.";
...
//for testing, lets me know if its multiplayer or not
    ...
    public void onRealTimeMessageReceived(RealTimeMessage rtm) {
        ...
        currentRowOpponent=(int)buf[2];
            ...
            else if (numExactlyCorrectOpponent!=4 && currentRowOpponent>=10 && numExactlyCorrect==4){
                won=true;
                lost=false;
