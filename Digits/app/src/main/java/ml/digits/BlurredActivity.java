...
public class BlurredActivity extends Activity {
    ...
    protected void onResume() { // Redraws the Share and Next Level buttons due to stupid bug that cuts off the rounded rectangle shape
        ...
        final ButtonAwesome homeButton = new ButtonAwesome(this);
        homeButton.setText(R.string.home_icon);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    homeButton.setTextColor(Integer.parseInt(MultiPlayerSignIn.currentAccent)); // Receive from MainActivity.java
                    i = new Intent(context, MultiPlayerSignIn.class);
                }
                startActivity(i);
                try {
                    // Play click sound effect
...
//why
        ...
        params9.setMargins(0, 0, 0, (int)(0.285*imageHeight));
